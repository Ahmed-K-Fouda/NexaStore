import AddToCartButton from "@/app/components/add_button/AddToCartButton";
      ...
      <div className="container mx-auto py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="flex flex-col gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="uppercase text-red-600 font-bold text-sm">
                      Mega saving
                    </span>
                  </div>
                </div>
            ...
            <div className="bg-gradient-to-r from-yellow-500/20 to-yellow-600/20 p-4 mt-4 rounded-xl">
